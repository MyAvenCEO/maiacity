...
language: de
added: 2026-09-11
categories: [architecture, ecology, housing]
hook: >-
  Steel and concrete built the modern world — and made construction the elephant in the climate
  room. What if the next cities were grown instead?
shift:
  from: Buildings are made of steel and concrete — and every one of them emits.
  to: Buildings can be grown from plants that pulled CO2 out of the air — and keep it stored.
quote: "We build our future buildings — whole cities — out of air."
quoteBy: Hans Joachim Schellnhuber
---
