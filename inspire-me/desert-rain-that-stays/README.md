...
hook: >-
  The Texas desert gets about as much rain as Los Angeles. The problem was never catching it —
  it was keeping it somewhere the plants can still drink it months later.
shift:
  from: Dry land means not enough rain, so catch more of it.
  to: The rain arrives and leaves. The real metric is how long water stays in the ground.
quote: "The mulch isn't just fertilizer, it's housing."
quoteBy: Shaun Overton
---
...
| --------------- | ---------------------------------------------------------------- |
| ~LA rainfall    | What this Texas desert actually gets — retention is the problem  |
| 4–7 ft          | Depth reached by sunflower, daikon, mustard and rapeseed roots   |
| up to 30°       | How much cooler mulched soil runs than bare soil                 |
| 350 yd³         | Wood chips he aims to put on one acre of "fertility factory"     |
| 18 in           | Height of the berm ringing Northfield, making one giant bathtub  |
| 6 in / 2–3 h    | The 1-in-10-year storm the bathtub is designed to hold           |
| 2.5 ft          | Depth of the observation well he opens to check for moisture     |
| 20 years        | Age of the mentor's compost mother pile                          |

## What we learn

- **Kickstart, then step back.** Seed, biology, three days of sprinkler, and leave it alone.
- **Aim for percolation, not just infiltration.** Gentler slopes sink more water; root channels carry it deep.
- **Build for the rare storm.** A berm all the way around means six inches in three hours stays put.
- **Measure what you can't see.** A shallow observation well: pull the cap, look for moisture.
...
- The mentor is anonymous and everything here is field experience, not trials. Which parts can we actually test on our own ground?
- "Biology" stays undefined — which organisms, applied how, and do they establish or wash out?
- He plans to aggregate soil microbes from across the US to select desert performers. What are the biosecurity and invasiveness risks?
- The mentor's method has four A's; the video names only armour and awaken. What are the other two?
- Year-one irrigation needs a well. What's the water budget, and how fast does the system pay it back?
