/**
 * Privacy Policy — the counsel-written English text from aven-brands
 * (brands/CEO/design-system/src/privacy.ts), copied verbatim. Sections that
 * describe services maia.city does not run are left out: encrypted payment
 * transactions, the AI assistant (phala.com) and eCommerce / payment
 * providers. Hosting (Hetzner) and the Bunny.net CDN are kept.
 */
...
export const PRIVACY_POLICY_EN: LegalDocument = {
	...
	"sections": [
		...
		{
			"level": 3,
			"title": "Data recording on this website",
			"blocks": []
		},
		{
			"level": 4,
			"title": "Who is the responsible party for the recording of data on this website (i.e., the “controller”)?",
			"blocks": [
				{
					"lines": [
		...
		{
			"level": 4,
			"title": "How do we record your data?",
			"blocks": [
				{
					"lines": [
		...
		{
			"level": 4,
			"title": "What are the purposes we use your data for?",
			"blocks": [
				{
					"lines": [
		...
		{
			"level": 4,
			"title": "What rights do you have as far as your information is concerned?",
			"blocks": [
				{
					"lines": [
		...
		{
			"level": 3,
			"title": "Analysis tools and tools provided by third parties",
			"blocks": [
				{
					"lines": [
		...
		{
			"level": 3,
			"title": "Information about the responsible party (referred to as the “controller” in the GDPR)",
			"blocks": [
				{
					"lines": [
		...
		{
			"level": 3,
			"title": "General information on the legal basis for the data processing on this website",
			"blocks": [
				{
					"lines": [
		...
		{
			"level": 3,
			"title": "Revocation of your consent to the processing of data",
			"blocks": [
				{
					"lines": [
		...
		{
			"level": 3,
			"title": "Right to object to the collection of data in special cases; right to object to direct advertising (Art. 21 GDPR)",
			"blocks": [
				{
					"lines": [
		...
		{
			"level": 3,
			"title": "Right to log a complaint with the competent supervisory agency",
			"blocks": [
				{
					"lines": [
		...
		{
			"level": 3,
			"title": "Information about, rectification and eradication of data",
			"blocks": [
				{
					"lines": [
		...
		{
			"level": 3,
			"title": "Right to demand processing restrictions",
			"blocks": [
				{
					"lines": [
		...
		{
			"level": 3,
			"title": "SSL and/or TLS encryption",
			"blocks": [
				{
					"lines": [
		...
		{
			"level": 3,
			"title": "Rejection of unsolicited e-mails",
			"blocks": [
				{
					"lines": [
		...
		{
			"level": 3,
			"title": "Request by e-mail, telephone, or fax",
			"blocks": [
				{
					"lines": [
