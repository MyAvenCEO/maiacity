...
They do not give you a single neighbour.

Not a street, not a door, not a face you would recognise at the fire in the evening. For three days the game treated those as the same thing. They are not.

## A card of land was too small for a city

On [Day 11](/blog/day-11-the-earth-in-cards/) I founded a Bakery on one card of the planet. Mara founded Solar on the next. One coop, one card.

It read well from orbit. It was wrong up close. A card of the planet is a region, not a building plot, and putting a single bakery on it is like buying a whole valley to open one shop.

So the card got a bigger job. It holds a city now.

## A city is a coop with its name on the money

The money rules did not have to change for that. A city is a coop like any other: the same milestones from [Day 12](/blog/day-12-the-first-believer-pays-least/), the same price climbing ten hearts at a time, a treasury, and minds.
...
## The card opens, and underneath it is an island

This is where the two sandboxes met.

[Day 05](/blog/day-05-the-first-settlement/) was Sandbox 1: one island of hexagons, where a single tent grows into a dome cell of 216 people. Sandbox 2 was the planet. They lived side by side, one small and close, one huge and far away.
...
## A home is a settlement, and a settlement is a coop too

Citizenship gets you onto the island. It does not give you a place on it.
...
A settler makes an invite link. It admits one person, and it expires after a week.
