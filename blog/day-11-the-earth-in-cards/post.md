...
Not because I forgot it. It had no Europe and no Atlantic either. It was a quarter sand and three quarters sea, with continents a random number generator had dreamed up on the very first evening of Sandbox 2.

It looked like a planet. It just was not ours, and a city cannot be planned on a planet that is not ours.

## An invented world lets you pretend

On [Day 05](/blog/day-05-the-first-settlement/) we grew one tent into a settlement on a hex of 41.6 hectares. That island was made up on purpose, because the settlement was the question, not the place.

A coop is different. A coop has to stand somewhere.

Is there water there? Does it freeze in January? Is it forest, or grass, or desert? On an invented planet every answer is whatever you want it to be. That is fine for a toy. It is poison for a city, because the moment you move from the game into soil, the real map is waiting with its own answers.

So the second morning of Sandbox 2 went into throwing the invented planet away.

## By noon the planet was real

Late the next morning the globe doubled in size. The cards stayed the same size, so there were four times as many of them.

Minutes later it had the real coastline, taken from Natural Earth, a free public-domain map of the world. Snow went onto the poles.
...
The camera came the same morning. Think of it as a drone that can land. From orbit you drag the whole globe around. Scroll down and the view tilts toward the horizon until you are standing on the cards, and the mouse becomes your gaze. Keys walk you forward.

Walking is the point. From orbit a coop is a dot. Standing next to it, it is a place.

## Not everyone founds, and that is on purpose

Anyone can look at the planet. You do not need an account to fly around it.

To mint hearts and back a coop, you join. To found one, you need one more thing: the coop founder role.
...
It asks for three things. A name. One line on what the coop is for, who it is for and why now. And your stake.
...
One press, and four things happen as a single step. It takes 500 of my own hearts. It creates 500 maiaHEARTS in the new coop's treasury. It gives me my first share of owning it. And it puts a small tower on card 4,297.
...
Mara founded Solar just inland from mine: solar panels for every dome cell, made in a dome factory next door. Jonas founded HempStone further south: building blocks grown from hemp, for the next ring of domes.
...
That is what the planet is for. It is a map of where people put their hearts.

There is one number I have not explained yet. When I founded the Bakery, my 500 hearts bought 11.50 pieces of it. When Lea put 300 hearts into Solar a little later, she got far fewer per heart than Mara did at the start. Nobody set those prices by hand. They follow a rule, and it is the most interesting thing in the whole game.

The live planet is still empty. Whoever founds the first coop there can choose from all 15,090 cards.

[Open avenCITY Sandbox 2 →](/games/sandbox-2/)

[Next: the first believer pays 10 hearts, the last will pay 490 →](/blog/day-12-the-first-believer-pays-least/)
